extends Node
# Credit: https://github.com/drkitt/godot-input-buffer/tree/main
...
const DEFAULT_BUFFER_WINDOW_MILLIISECONDS: int = 150
...
func is_action_press_buffered(action: String, buffer_window: int = DEFAULT_BUFFER_WINDOW_MILLIISECONDS) -> bool:
	# Get the inputs associated with the action. If any one of them was pressed in the last DEFAULT_BUFFER_WINDOW milliseconds,
